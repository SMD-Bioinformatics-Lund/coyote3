...
os.environ.setdefault("IDENTITY_DB", "coyote3_identity_test")
os.environ.setdefault("KNOWLEDGEBASE_DB", "coyote3_knowledgebase_test")
os.environ.setdefault("BAM_DB", "bam_test")
