...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("anonymous_client", "/dna/sample/SAMPLE_001/preview_report", 302),
        ("viewer_client", "/dna/sample/SAMPLE_001/preview_report", 200),
        ("user_client", "/dna/sample/SAMPLE_001/preview_report", 200),
        ("manager_client", "/dna/sample/SAMPLE_001/preview_report", 200),
        ("admin_client", "/dna/sample/SAMPLE_001/preview_report", 200),
    ],
)
