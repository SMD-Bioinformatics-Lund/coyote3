...
- `generic_case_control.yaml`: Example DNA ingestion spec, including `database_versions.vep`.
- `generic_rna_sample.yaml`: Example RNA ingestion spec, including `database_versions.vep`.
