...
COLLECTION_MODEL_ADAPTERS: dict[str, TypeAdapter[Any]] = {
    ...
    "cosmic_noncoding_variants": TypeAdapter(CosmicDoc),
    "cosmic_targeted_variants": TypeAdapter(CosmicDoc),
    "cosmic_breakpoints": TypeAdapter(CosmicProductDoc),
    "cosmic_structural_variants": TypeAdapter(CosmicProductDoc),
    "cosmic_copy_number": TypeAdapter(CosmicProductDoc),
    "cosmic_fusions": TypeAdapter(CosmicProductDoc),
    "cosmic_gene_expression": TypeAdapter(CosmicProductDoc),
    "cosmic_methylation": TypeAdapter(CosmicProductDoc),
    "cosmic_classifications": TypeAdapter(CosmicProductDoc),
    "cosmic_classification_papers": TypeAdapter(CosmicProductDoc),
    "cosmic_cancer_gene_census": TypeAdapter(CosmicProductDoc),
    "cosmic_cgc_hallmarks": TypeAdapter(CosmicProductDoc),
    "cosmic_genes": TypeAdapter(CosmicProductDoc),
    "cosmic_transcripts": TypeAdapter(CosmicProductDoc),
    "cosmic_census_gene_mutations": TypeAdapter(CosmicProductDoc),
    "cosmic_resistance_mutations": TypeAdapter(CosmicProductDoc),
    "cosmic_mutation_census": TypeAdapter(CosmicProductDoc),
    "cosmic_signature_sbs": TypeAdapter(CosmicProductDoc),
    "cosmic_signature_dbs": TypeAdapter(CosmicProductDoc),
    "cosmic_signature_sv": TypeAdapter(CosmicProductDoc),
    "cosmic_actionability": TypeAdapter(CosmicProductDoc),
    "versions": TypeAdapter(KnowledgebaseReleaseDoc),
