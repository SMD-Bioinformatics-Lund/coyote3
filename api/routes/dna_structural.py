"""DNA structural-variant routes (CNV and translocation families)."""
...
from api.contracts.dna import DnaCnvContextPayload, DnaCnvListPayload, DnaTranslocationContextPayload, DnaTranslocationsPayload
