...
class IsglService:
    ...
    def update(
        ...
        actor = current_actor(actor_username)
        now = utc_now()
        previous_version = int(genelist.get("version") or 1)
        ...
        updated_doc["supersedes_id"] = genelist.get("_id")
        ...
        result["meta"]["revision"] = {
            ...
            "previous_document_id": str(genelist.get("_id") or ""),
