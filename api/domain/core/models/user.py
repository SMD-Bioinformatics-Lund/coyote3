...
class UserModel(BaseModel):
    ...
    def _normalize_auth_type(cls, value):
        """Normalize scalar or list auth-provider values from persistence."""
    ...
    def from_auth_payload(
        ...
        for asp in asp_docs:
            ...
            if asp_family.startswith("panel"):
                asp_technology = "panel"
            else:
                asp_technology = asp_family
        ...
        merged_permissions = _unique_permission_ids(role_permissions)
