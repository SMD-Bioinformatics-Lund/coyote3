...
class HomeService:
    ...
    def isgl_items_payload(self, *, sample: dict) -> dict[str, Any]:
    ...
    def apply_isgl(self, *, sample: dict, payload: dict[str, Any], sample_id: str) -> dict[str, Any]:
        filters = sample.get("filters", {})
        ...
        return {"status": "ok", "sample_id": sample_id, "action": "apply_isgl", "isgl_ids": isgl_ids}
