...
def _dna_repo() -> MongoDNARouteRepository:
    ...
    # can patch this module's `store` without reaching into infra modules.
...
def _require_variant_for_sample(sample_id: str, var_id: str, user: ApiUser) -> tuple[dict, dict]:
    sample = _get_sample_for_api(sample_id, user)
    variant = _dna_repo().variant_handler.get_variant(var_id)
...
@router.post("/api/v1/dna/samples/{sample_id}/variants/{var_id}/unfp", response_model=SampleMutationPayload)
def unmark_false_variant(
    sample_id: str,
    var_id: str,
    user: ApiUser = Depends(require_access(permission="manage_snvs", min_role="admin")),
):
    _require_variant_for_sample(sample_id, var_id, user)
...
@router.post("/api/v1/dna/samples/{sample_id}/variants/{var_id}/fp", response_model=SampleMutationPayload)
...
@router.post("/api/v1/dna/samples/{sample_id}/variants/{var_id}/uninterest", response_model=SampleMutationPayload)
...
@router.post("/api/v1/dna/samples/{sample_id}/variants/{var_id}/interest", response_model=SampleMutationPayload)
...
@router.post("/api/v1/dna/samples/{sample_id}/variants/{var_id}/relevant", response_model=SampleMutationPayload)
...
@router.post("/api/v1/dna/samples/{sample_id}/variants/{var_id}/irrelevant", response_model=SampleMutationPayload)
...
@router.post("/api/v1/dna/samples/{sample_id}/variants/{var_id}/blacklist", response_model=SampleMutationPayload)
def add_variant_to_blacklist(
    sample_id: str,
    var_id: str,
    user: ApiUser = Depends(require_access(permission="manage_snvs", min_role="admin")),
):
    sample, variant = _require_variant_for_sample(sample_id, var_id, user)
    assay_config = _get_formatted_assay_config(sample)
    if not assay_config:
        raise _api_error(404, "Assay config not found for sample")
    assay_group = assay_config.get("asp_group", "unknown")
...
@router.post(
    "/api/v1/dna/samples/{sample_id}/variants/{var_id}/comments/{comment_id}/hide",
...
@router.post(
    "/api/v1/dna/samples/{sample_id}/variants/{var_id}/comments/{comment_id}/unhide",
    response_model=SampleMutationPayload,
)
...
@router.post("/api/v1/dna/samples/{sample_id}/variants/fp/bulk", response_model=SampleMutationPayload)
...
@router.post("/api/v1/dna/samples/{sample_id}/variants/irrelevant/bulk", response_model=SampleMutationPayload)
...
@router.post("/api/v1/dna/samples/{sample_id}/variants/bulk/tier", response_model=SampleMutationPayload)
...
@router.post("/api/v1/dna/samples/{sample_id}/variants/classify", response_model=SampleMutationPayload)
...
@router.post("/api/v1/dna/samples/{sample_id}/variants/rmclassify", response_model=SampleMutationPayload)
...
@router.post("/api/v1/dna/samples/{sample_id}/comments/add", response_model=SampleMutationPayload)
