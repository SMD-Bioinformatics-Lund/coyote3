...
from api.repositories.sample_repository import SampleRepository as MongoSamplesRepository
...
@router.post("/api/v1/samples/{sample_id}/sample_comments/add", response_model=SampleMutationPayload)
...
@router.post("/api/v1/samples/{sample_id}/sample_comments/{comment_id}/hide", response_model=SampleMutationPayload)
...
@router.post("/api/v1/samples/{sample_id}/sample_comments/{comment_id}/unhide", response_model=SampleMutationPayload)
...
@router.post("/api/v1/samples/{sample_id}/filters/update", response_model=SampleMutationPayload)
def update_sample_filters_mutation(
    ...
    if not isinstance(filters, dict):
        raise api_error(400, "Invalid filters payload")
...
@router.post("/api/v1/samples/{sample_id}/filters/reset", response_model=SampleMutationPayload)
...
@router.post("/api/v1/coverage/blacklist/update", response_model=CoverageBlacklistStatusPayload)
...
@router.post("/api/v1/coverage/blacklist/{obj_id}/remove", response_model=SampleMutationPayload)
