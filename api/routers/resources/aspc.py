...
@router.post("/api/v1/resources/aspc", response_model=AdminMutationPayload, status_code=201, summary="Create assay config")
...
@router.put("/api/v1/resources/aspc/{assay_id}", response_model=AdminMutationPayload, summary="Update assay config")
...
@router.patch("/api/v1/resources/aspc/{assay_id}/status", response_model=AdminMutationPayload, summary="Toggle assay config status")
...
@router.delete("/api/v1/resources/aspc/{assay_id}", response_model=AdminMutationPayload, summary="Delete assay config")
