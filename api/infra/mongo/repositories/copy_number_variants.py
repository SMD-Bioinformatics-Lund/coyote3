"""
CNVsRepository module for Coyote3
==============================

This module defines the `CNVsRepository` class used for accessing and managing
...
class CNVsRepository(FindingCommentOwnerMixin, BaseRepository):
    ...
    def delete_sample_cnvs(self, sample_oid: str) -> OperationResult:
        """
