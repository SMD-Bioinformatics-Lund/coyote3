"""
TranslocsRepository module for Coyote3
===================================

This module defines the `TranslocsRepository` class used for accessing and managing
...
class TranslocsRepository(FindingCommentOwnerMixin, BaseRepository):
    ...
    def get_transloc_annotations(self, tl: dict) -> list:
        ...
        # Keep latest classification tracked for parity with CNV annotation handling.
    ...
    def delete_sample_translocs(self, sample_oid: str) -> OperationResult:
        """
