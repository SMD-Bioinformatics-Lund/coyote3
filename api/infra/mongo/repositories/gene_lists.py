"""
ISGLRepository module for Coyote3
==========================================

This module defines the `ISGLRepository` class used for accessing and managing
...
# Class Definition
# -------------------------------------------------------------------------
class ISGLRepository(BaseRepository):
    """
    Coyote in silico gene asp database repository
    ...
    def ensure_indexes(self) -> None:
        ...
        col.create_index(
            ...
            partialFilterExpression={
                "isgl_id": {"$exists": True, "$type": "string"},
                "is_active": True,
            },
        )
        col.create_index(
    ...
    def ensure_isgl_id(self, data: dict) -> dict:
        """Ensure an ISGL payload carries a normalized business key."""
    ...
    def create_genelist(self, data: dict) -> OperationResult:
        """
    ...
    def get_isgl_by_ids(self, isgl_ids: list) -> dict:
        ...
        cursor = self.get_collection().find(
            {"isgl_id": {"$in": isgl_ids}, "is_active": True}, projection
        )
