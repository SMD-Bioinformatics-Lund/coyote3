"""
VEPMetaRepository module for managing VEP metadata
===============================================

This module provides the `VEPMetaRepository` class for handling VEP metadata stored
...
# Class Definition
# -------------------------------------------------------------------------
class VEPMetaRepository(BaseRepository):
    """
    VEPMetaRepository is a class for managing VEP metadata in the database.
    ...
    def get_db_info(self, vep_version: str, genome_build: str = "GRCh38") -> dict:
        ...
        if not db_info:
            self.adapter.app.logger.warning(
