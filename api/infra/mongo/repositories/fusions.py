"""
FusionsRepository module for Coyote3
=================================

This module defines the `FusionsRepository` class used for accessing and managing
...
class FusionsRepository(BaseRepository):
    ...
    def find_fusions_with_matching_breakpoints(
        ...
        """Find matching fusions in other samples by breakpoint pair."""
        base_projection = {
            "_id": 1,
            "SAMPLE_ID": 1,
            "fp": 1,
