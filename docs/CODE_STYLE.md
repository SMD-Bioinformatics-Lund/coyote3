...
### Anti-patterns
- placing business logic in `routes/` and skipping `services/`
...
- Route module files should match feature families (`api/routes/dna.py`, `api/routes/reports.py`).
