...
4. **Continuous Integration**: The default integration branch must remain in a stable, validated state at all times. Automated CI cascades must pass 100% of checks before merge operations.
