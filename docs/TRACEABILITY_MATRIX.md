...
| Small variant workflow integrity | `api/routers/small_variants.py`, `api/services/small_variant_service.py`, `api/services/resource_classification_service.py` | small variant list/detail behavior, tiering, and annotation boundaries | small variant route/service tests |
| Fusion workflow integrity | `api/routers/fusions.py`, `api/services/fusion_service.py`, `api/core/workflows/rna_workflow.py` | fusion filter normalization and context generation | fusion route/workflow tests |
