...
![URL and request flow](../assets/diagrams/url-request-flow.svg)
...
![Collection relationship chain](../assets/diagrams/collection-relationships.svg)
...
![Login provider resolution](../assets/diagrams/login-provider-resolution.svg)
