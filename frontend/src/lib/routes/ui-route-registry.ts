...
export const uiRouteRegistry: UiRouteAudit[] = [
  ...
  },
  {
    ...
    dataUsed: ["tiered clinical findings", "sample, report, and annotation references"],
  },
  {
    ...
    dataUsed: ["profiled sample denominator", "latest reported typed findings", "assay prevalence", "sex distribution", "recurrent findings"],
  },
  {
    path: "/variants",
    page: "TieredVariantSearch",
    area: "clinical",
    api: ["GET /common/search/tiered_variants"],
    dataUsed: ["tiered clinical findings", "assay counts", "search parameters"],
  },
  {
  ...
  },
  {
    ...
    dataUsed: ["application version", "database names", "reference versions", "software versions", "installed knowledgebase releases", "support links"],
  },
  {
    path: "/contact",
    page: "ContactPage",
    ...
    dataUsed: ["organization", "support contacts", "service hours", "public links"],
  },
  {
