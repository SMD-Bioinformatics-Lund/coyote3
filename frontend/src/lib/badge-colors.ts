...
export const configuredValueClasses: Record<string, string> = {
  ...
  production: "border-teal-300/70 bg-teal-50 text-teal-800 dark:border-teal-400/35 dark:bg-teal-400/10 dark:text-teal-200",
  development: "border-sky-300/70 bg-sky-50 text-sky-800 dark:border-sky-400/35 dark:bg-sky-400/10 dark:text-sky-200",
  testing: "border-violet-300/70 bg-violet-50 text-violet-800 dark:border-violet-400/35 dark:bg-violet-400/10 dark:text-violet-200",
  validation: "border-cyan-300/70 bg-cyan-50 text-cyan-800 dark:border-cyan-400/35 dark:bg-cyan-400/10 dark:text-cyan-200",
