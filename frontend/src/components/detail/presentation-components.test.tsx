...
describe("detail presentation components", () => {
  ...
  it("renders page and surface headings, actions, descriptions, and metrics", () => {
    render(
      <PageShell eyebrow="Clinical" title="Finding" description="Review context" actions={<button>Save</button>}>
        <SurfacePanel title="Evidence" description="Curated sources" actions={<button>Refresh</button>}>
  ...
  it("supports linked images and an explicit image failure state", () => {
    render(<RotatableImage src="/profile.png" alt="CNV profile" href="/profile.png" rotation={90} />)
