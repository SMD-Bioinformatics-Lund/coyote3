...
const AdminIngestPage = lazy(() => import("./pages/admin/AdminUtilityPages").then((module) => ({ default: module.AdminIngestPage })))
const AdminSchemasPage = lazy(() => import("./pages/admin/AdminSchemasPage"))
const PublicCatalog = lazy(() => import("./pages/catalog/PublicCatalog").then((module) => ({ default: module.PublicCatalog })))
const PublicCatalogMatrix = lazy(() => import("./pages/catalog/PublicCatalog").then((module) => ({ default: module.PublicCatalogMatrix })))
...
const PublicAspGenesPage = lazy(() => import("./pages/resources/CommonResourcePages").then((module) => ({ default: module.PublicAspGenesPage })))
const PublicGenelistPage = lazy(() => import("./pages/resources/CommonResourcePages").then((module) => ({ default: module.PublicGenelistPage })))
